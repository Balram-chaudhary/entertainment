             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="sname" id="sname" placeholder="Enter Name of the Sports" value="{{old('sname')}}" required="required">
                      <span class="help-block errortext">{{$errors->first('sname')}}</span>
                  </div>
                </div>
                <div class="form-group">
                    <label for="gimage" class="col-sm-2 control-label">Sports Image</label>
                    <div class="col-sm-10">
                  ...
                  <div class="col-sm-10">
                    <textarea name="description" class="form-control" id="description" placeholder="Enter Sports Description" rows="10" cols="90" required="required" >{{old('description')}}</textarea>
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <select name="stype" id="stype" required="required">
                    ...
                    <option value="v">Vollyball</option>
                    <option value="b">Basketball</option>
                    <option value="k">Kabaddi</option>
                    <option value="bt">Batminton</option>
                    <option value="r">Raceling</option>
                    <option value="t">Tekwando</option>
                    <option value="m">Martial Art</option>
