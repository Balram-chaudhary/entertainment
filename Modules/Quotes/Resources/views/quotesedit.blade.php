          ...
          <div class="box box-info">
            ...
            <form  action="" class="form-horizontal formpadding" id="quotes" method="POST" enctype="multipart/form-data" file="true" name="quotes">
             ...
             <input type="hidden" name="quote_id" value="{{$quotes->id}}">
              <input type="hidden" name="old_quote_image" value="{{$quotes->qimage}}">
              <div class="box-body">
                <div class="form-group">
                  <label for="title" class="col-sm-2 control-label">Quotes Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="qname" id="qname" placeholder="Quotes Name" value="{{$quotes->qname}}" required="required">
                      <span class="help-block errortext">{{$errors->first('qname')}}</span>
                  </div>
                </div>
               ...
               <div class="col-lg-1 col-md-1 col-sm-1">
                 <a href="{{url('/images/'.$quotes->qimage)}}"class="portfolio-box">
                  <img src="{{url('/images/'.$quotes->qimage)}}"class="img-responsive" alt="images" width="100px" height="100px">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select name="is_approved" id="is_approved" required="required">
                    <option value="y" @if($quotes->is_approved=='y') selected='selected' @endif>Yes</option>
                    <option value="n" @if($quotes->is_approved=='n') selected='selected' @endif>No</option>
                  </select>
                 </div>
                </div>
                <div class="form-group">
