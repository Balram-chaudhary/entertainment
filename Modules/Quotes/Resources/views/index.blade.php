             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="qname" id="qname" placeholder="Quotes Name" value="{{old('qname')}}" required="required">
                      <span class="help-block errortext">{{$errors->first('qname')}}</span>
                  </div>
                </div>
                <div class="form-group">
                    <label for="qimage" class="col-sm-2 control-label">Quotes Image</label>
                    <div class="col-sm-10">
