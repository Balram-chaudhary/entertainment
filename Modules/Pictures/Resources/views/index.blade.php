             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pname" id="pname" placeholder="Picture Name" value="{{old('pname')}}" required="required">
                      <span class="help-block errortext">{{$errors->first('pname')}}</span>
                  </div>
                </div>
                <div class="form-group">
                    <label for="himage" class="col-sm-2 control-label">Pictures Image</label>
                    <div class="col-sm-10">
